...
namespace toolStrip
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            trackBar1.Value = (int)VideoPlayerController.AudioManager.GetMasterVolume();
            vol.Text = ((int)VideoPlayerController.AudioManager.GetMasterVolume()).ToString();
        }
        ...
        {
            button1.BackgroundImage = Properties.Resources.redX;
        }

        private void button1_MouseLeave(object sender, EventArgs e)
        {
            button1.BackgroundImage = Properties.Resources.normalX;
        }

        private void trackBar1_Scroll(object sender, EventArgs e)
        {
            VideoPlayerController.AudioManager.SetMasterVolume(trackBar1.Value);
